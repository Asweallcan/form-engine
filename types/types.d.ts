...
export type MutationRes = Omit<Field, "type" | "props" | "mutations" | "validationRules"> | undefined;
export type Mutation = (currentFieldValue: any, triggerFieldValue: any) => MutationRes | Promise<MutationRes>;
...
export type LayoutItem<T extends string = string> = T | {
    field: T;
    style: CSSProperties;
} | {
...
export type TooltipInfoIconType = ComponentType<{
    tooltip: ReactNode;
}>;
